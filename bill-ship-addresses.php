                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 d-flex justify-content-between align-items-center">
                                ...
                                <!--Breadcrumbs-->
                                <div class="breadcrumbs"><a href="index.html" title="Back to the home page">Home</a><span class="main-title fw-bold"><i class="icon anm anm-angle-right-l"></i>My Account</span></div>
                                <!--End Breadcrumbs-->
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="dashboard-sidebar bg-block">
                                ...
                                <div class="dashboard-tab">
                                    <ul class="nav nav-tabs flex-lg-column border-bottom-0" id="top-tab" role="tablist">
                                        <li class="nav-item"><a href="my-account.php" class="nav-link active">Account Info</a></li>
                                        <li class="nav-item"><a href="my-account.php"  class="nav-link">Change Password</a></li>
                                        ...
                                        <li class="nav-item"><a href="pending-orders.php" class="nav-link">Payment Pending Order</a></li>
