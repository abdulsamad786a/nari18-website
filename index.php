...
<div id="page-content" class="mb-0">
    ...
    <style>
        ...
        .btn-add-to-cart:hover .material-symbols-outlined,
    ...
    <section class="testimonials-section">
        <div class="container">
            ...
            <div class="testimonials-navigation">
                <button class="testimonial-nav-btn" id="testimonialPrevBtn">
                    <span class="material-icons-outlined">chevron_left</span>
                </button>
                <button class="testimonial-nav-btn" id="testimonialNextBtn">
...
<style>
    ...
    .testimonial-nav-btn:hover {
        background: rgba(139, 110, 78, 0.9);
        transform: translateY(-4px);
        box-shadow: 0 10px 15px -3px rgba(139, 110, 78, 0.2);
    }

    .testimonial-nav-btn .material-icons-outlined {
        font-size: 24px;
    }
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function updateTestimonials() {
            ...
            // Update left card
            if (leftCard) {
                leftCard.querySelector('.testimonial-quote-text').textContent = `"${prev.quote}"`;
                leftCard.querySelector('.testimonial-author-name').textContent = prev.author;
                leftCard.querySelector('.testimonial-author-role').textContent = prev.role;
            }

            // Update center card
            if (centerCard) {
                centerCard.querySelector('.testimonial-quote-main').textContent = `"${current.quote}"`;
                centerCard.querySelector('.testimonial-author-name-main').textContent = current.author;
                centerCard.querySelector('.testimonial-author-role-main').textContent = current.role;
            }

            // Update right card
            if (rightCard) {
                rightCard.querySelector('.testimonial-quote-text').textContent = `"${next.quote}"`;
                rightCard.querySelector('.testimonial-author-name').textContent = next.author;
                rightCard.querySelector('.testimonial-author-role').textContent = next.role;
            }
        }
