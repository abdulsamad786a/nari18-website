...
// Increase execution time for large image uploads/processing
set_time_limit(300);
...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$productimage2 = strtolower($_FILES["productimage2"]["name"]);
		...
		// Insert product first to get the auto-increment ID
		...
		if ($sql) {
			// Get the actual product ID from database
			...
			// Use the LOWERCASE variable names for the destination file
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="url" name="productVideo" id="productVideo"
													placeholder="Enter YouTube Video URL (Optional)" class="span8 tip"
										...
										<div class="control-group">
											<div class="controls">
												<button type="submit" name="submit" class="btn"
													onclick="this.innerHTML='Inserting...';">Insert</button>
											</div>
										</div>
									</form>
								</div>
