        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 main-col">
                ...
                <table class="table align-middle" id="cartTable">
                    ...
                    ?>
                        <tr class="cart-row cart-flex position-relative" data-pid="<?php echo $row['id']; ?>" id="row-<?php echo $row['id']; ?>">
                            <td class="cart-delete text-center">
                                <a href="#" class="remove-item" data-pid="<?php echo $row['id']; ?>" title="Remove item">
                                    <i class="icon anm anm-times-r" style="font-size: 20px; color: #dc3545;"></i>
                                </a>
                            </td>
...
(function(){
    ...
    table.addEventListener('click', function(e){
        const removeBtn = e.target.closest('a.remove-item');
