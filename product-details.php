...
<div class="product-page-wrapper">
    ...
    <nav class="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        <ol class="flex flex-wrap items-center gap-2 text-[10px] uppercase tracking-widest text-stone-400">
            ...
            <li><a class="hover:text-stone-900 transition-colors"
                    href="category.php?cid=<?php echo $row['category']; ?>"><?php echo htmlentities($breadcrumb['catname']); ?></a>
            </li>
            <li><svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                </svg></li>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16">
            ...
            <div class="lg:col-span-7 space-y-4">
                ...
                <div class="zoom-hover overflow-hidden rounded-lg bg-stone-100 aspect-[4/5] relative">
                    <img id="main-product-image" alt="<?php echo htmlentities($row['productName']); ?>"
                    ...
                    <?php if ($row['productAvailability'] == 'In Stock'): ?>
                        <div
                            class="absolute top-4 right-4 bg-white/90 px-3 py-1 text-[10px] tracking-widest uppercase font-semibold rounded">
                            New Arrival</div>
                    <?php else: ?>
                        <div
                            class="absolute top-4 right-4 bg-red-600 text-white px-3 py-1 text-[10px] tracking-widest uppercase font-semibold rounded">
                            Out of Stock</div>
                    <?php endif; ?>
                </div>
            ...
            <div class="lg:col-span-5 flex flex-col">
                ...
                <div class="border-b border-stone-200 pb-6 sm:pb-8">
                    ...
                    <div class="flex items-center gap-1 mb-3">
                        ...
                        <svg class="w-4 h-4 text-[#D4AF37]" viewBox="0 0 20 20">
                            <defs>
                    ...
                    <!-- Product Name -->
                    <h2
                        class="font-display text-3xl sm:text-4xl lg:text-5xl font-semibold mb-4 leading-tight text-stone-900">
                        <?php echo htmlentities($row['productName']); ?>
                    </h2>

                    <!-- Price -->
                    <div class="flex flex-wrap items-baseline gap-3 sm:gap-4 mb-6">
                        <span class="text-xl sm:text-2xl font-light tracking-tight text-stone-900">Rs.
                            <?php echo number_format($row['productPrice']); ?>.00</span>
                        <?php if ($row['productPriceBeforeDiscount'] > $row['productPrice']): ?>
                            <span class="text-stone-400 line-through text-base sm:text-lg font-light">Rs.
                                <?php echo number_format($row['productPriceBeforeDiscount']); ?>.00</span>
                            <?php
                            $discount = round((($row['productPriceBeforeDiscount'] - $row['productPrice']) / $row['productPriceBeforeDiscount']) * 100);
                            ?>
                            <span
                                class="text-primary text-xs font-bold uppercase tracking-widest bg-primary/5 px-2 py-1 rounded">Save
                            ...
                            <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                                ...
                                <div class="flex items-center h-14">
                                    <button onclick="decrementQty()"
                                        class="px-4 py-2 hover:text-primary transition-colors text-lg">−</button>
                                    <input type="text" id="product-quantity" value="1"
                                        class="w-12 text-center bg-transparent border-none focus:ring-0 text-sm"
                                        readonly />
    ...
    <div id="video-modal" class="fixed inset-0 bg-black/80 z-50 flex items-center justify-center p-4 hidden">
        <div class="bg-white rounded-lg max-w-4xl w-full overflow-hidden relative">
            <button onclick="closeVideoModal()"
                class="absolute top-4 right-4 z-10 w-10 h-10 bg-white rounded-full flex items-center justify-center hover:bg-stone-100 transition-colors">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                </svg>
            </button>
            <div class="aspect-video">
                <iframe id="video-iframe" class="w-full h-full" src="" frameborder="0" allow="autoplay; encrypted-media"
                    allowfullscreen>
                </iframe>
            </div>
        </div>
