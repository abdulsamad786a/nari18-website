                        ...
                        <div class="product-action w-100 d-flex-wrap my-3 my-md-4">
                            ...
                            <div class="product-form-quantity d-flex-center">
                                <div class="qtyField" style="height:0;">
                                    <a class="qtyBtn minus" href="javascript:void(0);" onclick="decrementQty()"><i class="icon anm anm-minus-r"></i></a>
                                    <input type="text" id="product-quantity" value="1" name="quantity" pattern="[0-9]*" class="product-form-input qty" readonly />
                                    <a class="qtyBtn plus" href="javascript:void(0);" onclick="incrementQty()"><i class="icon anm anm-plus-r"></i></a>
                                </div>
                            </div>
...
.text a {font-family: Poppins, sans-serif !important;
}
...
<script>
// Increment Quantity
$(document).on("click", ".qtyAdjust.plus", function () {
    let input = $(this).siblings("input");
    let val = parseInt(input.val()) || 1;
    input.val(val + 1);
});

$(document).on("click", ".qtyAdjust.minus", function () {
    let input = $(this).siblings("input");
    let val = parseInt(input.val()) || 1;
