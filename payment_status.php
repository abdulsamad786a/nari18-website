...
if ($status == 'success') {
    if ($method == 'cod') {
        ...
        $icon = "✓";
        $message = "Thank you! Your order has been confirmed with Cash on Delivery.";
        $sub_message = "Your order of ₹" . (isset($_SESSION['grandtotal_data']) ? $_SESSION['grandtotal_data'] : '') . " will be collected at the time of delivery.";
    } else {
            ...
            <div class="row">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 d-flex justify-content-between align-items-center">
                    ...
                    <div class="breadcrumbs"><a href="index.php" title="Back to the home page">Home</a><span
                            class="main-title fw-bold"><i class="icon anm anm-angle-right-l"></i>Payment Status</span>
                    </div>
                    <!--End Breadcrumbs-->
                </div>
            </div>
                ...
                <div class="card shadow border-0">
                    <div class="card-body text-center p-5">
                        ...
                        <div class="status-icon mb-4">
                            <div
                                class="icon-circle <?php echo $alert_class; ?> d-inline-flex align-items-center justify-content-center rounded-circle">
                        ...
                        <!-- Status Title -->
                        <h2
                            class="card-title mb-3 <?php echo $status == 'success' ? 'text-success' : 'text-danger'; ?>">
                            <?php echo $title; ?>
                        </h2>
                                    ...
                                    <div class="payment-details mt-3 p-3 bg-white rounded w-100">
                                        ...
                                        <div class="row text-start">
                                            <div class="col-6">
                                                ...
                                                <p class="mb-2 fw-bold"><?php echo substr($payment_id, 0, 12) . '...'; ?>
                                                </p>
                                            </div>
                                            <div class="col-6">
                                            ...
                                            <?php if (isset($_SESSION['grandtotal_data'])): ?>
                                                <div class="col-12">
                                                    ...
                                                    <p class="mb-0 fs-5 fw-bold text-success">₹
                                                        <?php echo $_SESSION['grandtotal_data']; ?></p>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                        ...
                        <div class="mt-5 pt-3 border-top">
                            <?php if ($status == 'success'): ?>
                                <p class="text-muted mb-2">
                                    <i class="icon anm anm-envelope-l me-2"></i>A confirmation email has been sent to your
                            ...
                            <?php else: ?>
                                <p class="text-muted mb-2">
                                    <i class="icon anm anm-info-circle me-2"></i>If money was deducted from your account, it
                                    will be refunded within 5-7 business days.
                                </p>
                                <p class="text-muted mb-0">
                                    <i class="icon anm anm-exclamation-triangle me-2"></i>Please ensure your card details
                                    and internet connection are correct.
                                </p>
                            <?php endif; ?>
                        </div>
                    </div>
